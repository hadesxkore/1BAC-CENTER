...
export const generatePNPSummaryPDF = async (
  ...
  const addPageFooter = () => {
    ...
    doc.text('PNP Reports Summary', margin, pageHeight - 12)
  ...
  doc.text('PNP', pageWidth / 2, yPos, { align: 'center' })
  ...
  const metrics = [
    { label: 'Total Reports', value: totalConcerns.toString() },
  ...
  districts.forEach((district, districtIndex) => {
    ...
    const districtCards = [
      ...
      { label: 'For Validation', value: districtForValidation },
      { label: 'Completed', value: districtCompleted },
    ]
